...
```
now open bot.py and change the guild_id to your server id and change the token to your discord bots token and finally change 'OPENAI KEY' to your OpenAI token.
